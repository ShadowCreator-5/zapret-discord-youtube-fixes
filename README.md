...
Проверьте возможность зайти на obsproject.com. Если не получается, то ALT перестал пробивать блокировку OVH. Проведите DPI-тест и выберите другой,который пробивает
